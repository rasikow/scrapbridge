...
export default function BuyerApprovalsPage() {
  ...
  function reload() {
    adminService.listApprovals({ role: 'buyer' }).then(setApprovals)
  }
  ...
  return (
    <DashboardShell showSearch={false}>
      <PageHeader icon={UserCheck} eyebrow="Platform-wide" title="Buyer approvals" subtitle="Verify new buyer registrations before they can trade." />
      ...
      {!approvals ? (
        ...
        <EmptyState icon={UserCheck} title="No buyers here" description="Registrations matching this filter will show up here." />
      ) : (
